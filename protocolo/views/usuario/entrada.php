            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="alert alert-info">
                        <i class="fa fa-folder-open"></i>&nbsp;Olar! <b> <?php echo $v_nome; ?></b> aqui estada TODOS os documentos recentes<b>!</b>
                    </div>
                </div>
                <!--end  Welcome -->
            </div>
                        ...
                        <table class="table table-bordered table-striped">
                            <thead>
                                  <tr>
                                    ...
                                    <th>Status</th>
                                    <th>Arquivo</th>
                                    <th>Mais op&ccedil;&otilde;es </th>
                                    <th>Ultima Observa&ccedil;&atilde;o</th>
                                </tr>
                            </thead>
                            <tbody>
                        <?php
                        function entrada($cod_setor){
                            ...
                            $sql = "SELECT a.protocolo, a.requerente, h.remetente AS cod_remetente, h.destinatario AS cod_destinatario, a.assunto, st.nome_status AS
									...
									AND h.destinatario = $cod_setor and h.ativo = 1
