 ...
 ?>
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <!-- Page Header -->
                <div class="col-lg-12">
                    <h1 class="page-header">Indeferidos</h1>
                </div>
                <!--End Page Header -->
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="alert alert-info">
                        <i class="fa fa-folder-open"></i>&nbsp;Olar! <b> <?php echo $v_nome; ?></b> voce esta na area de <b>DOCUMENTOS INDEFERIDOS!</b>
                    </div>
                </div>
                <!--end  Welcome -->
            </div>
            <div class="row">
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php
                                    function indeferidos($cod_setor){
                                        ...
                                        $sql = "SELECT a.protocolo, a.requerente, h.remetente AS cod_remetente, h.destinatario AS cod_destinatario, a.assunto, st.nome_status AS
                                                    ...
                                                    AND h.destinatario = $cod_setor and h.ativo = 1 and h.ref_cod_status = 3
             ...
             <!-- end row -->
              <div style="float: right;">
                <form method="POST" action="index.php?link=4">
