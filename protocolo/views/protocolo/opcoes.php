...
$protocolo = $_SESSION['v_protocolo'];
?>
      <!--  page-wrapper -->
        <div id="page-wrapper">
			...
			<div class="row">
                ...
                <div class="col-lg-12">
                    <div class="alert alert-info">
                        <i class="fa fa-folder-open"></i>&nbsp;Olar! <b> <?php echo $v_nome; ?></b> voce esta na area do <b>Protocolo de Numero <?php echo $_SESSION['v_protocolo'];?></b> referente a este <a href="../model/upload/<?php echo $_SESSION['v_arquivo'];?>" target="_blank" > Arquivo</a>. 
                     <h5>Requerente:</h5><h4><?php echo   $_POST['requerente'];?></h4>
                    </div>
                </div>
                <!--end  Welcome -->
            </div>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                         ...
                                         <form action="../model/deferir_indeferir_encaminhar.php" method="POST" enctype="multipart/form-data"> 
                                          ...
                                          <input name="protocolo" type="hidden" value="<?php echo $_SESSION['v_protocolo']; ?>">
                                        
                                          <input name="cod_remetente" type="hidden" value="<?php echo $_SESSION['v_cod_remetente']; ?>">
                                         
                                          <input name="cod_destinatario" type="hidden" value="<?php echo $_SESSION['v_cod_destinatario'] ?>">
